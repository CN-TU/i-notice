...
if _train:
    ...
    history = model.fit(X_training_set, y_training_set, validation_split=0.33, epochs=epochs, batch_size=batch_size, verbose=verbose)
    ...
    # EWC
    I = computer_fisher(model, X_training_set)
...
if freeze:
    ...
    model.get_layer('max_pooling1d_2').trainable = False
    model.get_layer('conv1d_3').trainable = False
